...
- Frame → applying those tendencies  
...
These map cleanly to **Core** in COOL.
...
COOL (online) + MOOL (offline) reproduces this architecture.
...
why COOL works, and why it aligns with human cognition.
